...
const Card = ({card, title, restStyles, playerTwo}) => {
  return (
    <div className={`${styles.cardContainer} ${restStyles}`}>
      ...
      <div className={`${styles.cardPointContainer} md:left-[26.2%] left-[26%] bottom-[30%] ${styles.flexCenter}`} >
        <p className={`${styles.cardPoint} text-yellow-400`} > { card.att } </p>
      </div>
      <div className={`${styles.cardPointContainer} md:right-[20.2%] right-[21.5%] bottom-[30%] ${styles.flexCenter}`} >
